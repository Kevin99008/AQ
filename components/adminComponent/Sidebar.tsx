...
export default function Sidebar() {
    ...
    <ul className="space-y-2">
      <li>
        <Link
          ...
          className="flex items-center space-x-2 px-2 py-4 place-content-center bg-green-500 rounded hover:bg-green-700"
      ...
      <li>
        <Button
          ...
          className="flex items-center space-x-2 p-2 rounded hover:bg-red-500 w-full"
        >
          <LogOut size={20} />
          <span>Logout</span>
        </Button>
  ...
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <div className="hidden md:block w-64 bg-gray-800 text-white p-4 h-screen overflow-y-auto">
